...
function getLoginPalette(theme: LoginTheme): LoginPalette {
  switch (theme) {
    ...
    case "bloomberg": return {
      haloUpper:          "hsl(25 80% 20% / 0.4)",
      nebulaA:            "hsl(25 90% 45% / 0.35)",
      nebulaB:            "hsl(30 80% 38% / 0.2)",
      nebulaC:            "hsl(35 70% 28% / 0.08)",
      rim1:               "hsl(30 100% 88%)",
      rim2:               "hsla(25, 100%, 72%, 0.85)",
      rim3:               "hsla(20, 100%, 58%, 0.5)",
      rim4:               "hsla(15, 90%, 48%, 0.25)",
      bleedLeftA:         "hsl(25 95% 52% / 0.5)",
      bleedLeftB:         "hsl(20 85% 42% / 0.2)",
      bleedRightA:        "hsl(35 95% 62% / 0.45)",
      bleedRightB:        "hsl(40 85% 52% / 0.2)",
      hotspot1:           "hsl(30 100% 90%)",
      hotspot2:           "hsl(25 100% 75%)",
      hotspot3:           "hsl(20 95% 58% / 0.7)",
      hotspot4:           "hsl(15 85% 45% / 0.35)",
      hotspot5:           "hsl(10 70% 35% / 0.1)",
      halo1:              "hsl(25 95% 62% / 0.4)",
      halo2:              "hsl(20 85% 48% / 0.2)",
      halo3:              "hsl(15 75% 38% / 0.08)",
      core1:              "hsl(30 100% 88%)",
      core2:              "hsl(25 100% 72%)",
      core3:              "hsl(20 100% 56%)",
      core4:              "hsl(15 95% 45% / 0.5)",
      orb1:               "hsl(25 95% 52%)",
      orb1Tail:           "hsl(20 85% 42% / 0.4)",
      orb2:               "hsl(35 90% 58%)",
      orb2Tail:           "hsl(40 80% 48% / 0.35)",
      orb3:               "hsl(15 95% 50%)",
      orb3Tail:           "hsl(10 85% 40% / 0.35)",
      orb4:               "hsl(30 95% 60%)",
      orb4Tail:           "hsl(30 85% 50% / 0.4)",
      orb5:               "hsl(38 100% 68%)",
      orb5Tail:           "hsl(33 90% 55% / 0.5)",
      buttonGradStart:    "hsl(25 100% 50%)",
      buttonGradEnd:      "hsl(35 100% 55%)",
      buttonGradStartBusy:"hsl(25 65% 38%)",
      buttonGradEndBusy:  "hsl(35 60% 38%)",
      buttonShadow:       "hsl(25 90% 48% / 0.38)",
      liveBadgeBorder:    "hsl(25 90% 58% / 0.45)",
      liveBadgeBg:        "hsl(25 90% 58% / 0.1)",
      liveBadgeDot:       "hsl(25 100% 60%)",
      liveBadgeText:      "hsl(25 100% 75%)",
      accentTextA:        "hsl(30 100% 68%)",
      accentTextB:        "hsl(20 95% 58%)",
      accentTextGlowMid:  "hsl(30 100% 68% / 0.5)",
      accentTextGlowWide: "hsl(20 95% 58% / 0.35)",
      inputFocus:         "hsl(25 85% 58% / 0.5)",
      badgeBoxShadow:     "hsl(25 90% 55% / 0.45)",
      badgeBorder:        "hsl(25 70% 40% / 0.4)",
    }
    case "nord": return {
      haloUpper:          "hsl(210 30% 30% / 0.4)",
      nebulaA:            "hsl(193 45% 50% / 0.35)",
      nebulaB:            "hsl(200 40% 42% / 0.2)",
      nebulaC:            "hsl(210 35% 32% / 0.08)",
      rim1:               "hsl(195 80% 90%)",
      rim2:               "hsla(193, 50%, 78%, 0.85)",
      rim3:               "hsla(200, 45%, 62%, 0.5)",
      rim4:               "hsla(210, 40%, 50%, 0.25)",
      bleedLeftA:         "hsl(193 55% 58% / 0.5)",
      bleedLeftB:         "hsl(200 45% 48% / 0.2)",
      bleedRightA:        "hsl(185 55% 65% / 0.45)",
      bleedRightB:        "hsl(190 45% 55% / 0.2)",
      hotspot1:           "hsl(195 75% 90%)",
      hotspot2:           "hsl(193 55% 78%)",
      hotspot3:           "hsl(200 50% 62% / 0.7)",
      hotspot4:           "hsl(210 40% 48% / 0.35)",
      hotspot5:           "hsl(220 30% 38% / 0.1)",
      halo1:              "hsl(193 55% 65% / 0.4)",
      halo2:              "hsl(200 45% 50% / 0.2)",
      halo3:              "hsl(210 35% 40% / 0.08)",
      core1:              "hsl(195 80% 88%)",
      core2:              "hsl(193 60% 72%)",
      core3:              "hsl(200 50% 58%)",
      core4:              "hsl(210 45% 48% / 0.5)",
      orb1:               "hsl(193 50% 58%)",
      orb1Tail:           "hsl(200 40% 48% / 0.4)",
      orb2:               "hsl(180 50% 62%)",
      orb2Tail:           "hsl(185 42% 52% / 0.35)",
      orb3:               "hsl(210 55% 55%)",
      orb3Tail:           "hsl(215 45% 45% / 0.35)",
      orb4:               "hsl(195 55% 65%)",
      orb4Tail:           "hsl(193 45% 55% / 0.4)",
      orb5:               "hsl(188 65% 72%)",
      orb5Tail:           "hsl(192 55% 60% / 0.5)",
      buttonGradStart:    "hsl(193 43% 62%)",
      buttonGradEnd:      "hsl(210 50% 55%)",
      buttonGradStartBusy:"hsl(193 30% 42%)",
      buttonGradEndBusy:  "hsl(210 35% 38%)",
      buttonShadow:       "hsl(193 45% 55% / 0.35)",
      liveBadgeBorder:    "hsl(193 50% 62% / 0.45)",
      liveBadgeBg:        "hsl(193 50% 62% / 0.1)",
      liveBadgeDot:       "hsl(193 58% 65%)",
      liveBadgeText:      "hsl(193 55% 80%)",
      accentTextA:        "hsl(193 60% 72%)",
      accentTextB:        "hsl(210 55% 65%)",
      accentTextGlowMid:  "hsl(193 60% 72% / 0.5)",
      accentTextGlowWide: "hsl(210 55% 65% / 0.35)",
      inputFocus:         "hsl(193 48% 62% / 0.5)",
      badgeBoxShadow:     "hsl(193 50% 60% / 0.45)",
      badgeBorder:        "hsl(193 35% 42% / 0.4)",
    }
    case "cyber": return {
      haloUpper:          "hsl(300 60% 18% / 0.4)",
      nebulaA:            "hsl(300 90% 50% / 0.35)",
      nebulaB:            "hsl(285 80% 42% / 0.2)",
      nebulaC:            "hsl(270 70% 32% / 0.08)",
      rim1:               "hsl(305 100% 90%)",
      rim2:               "hsla(300, 100%, 75%, 0.85)",
      rim3:               "hsla(290, 100%, 62%, 0.5)",
      rim4:               "hsla(275, 90%, 52%, 0.25)",
      bleedLeftA:         "hsl(300 100% 58% / 0.5)",
      bleedLeftB:         "hsl(285 90% 48% / 0.2)",
      bleedRightA:        "hsl(315 100% 65% / 0.45)",
      bleedRightB:        "hsl(320 90% 55% / 0.2)",
      hotspot1:           "hsl(305 100% 92%)",
      hotspot2:           "hsl(300 100% 78%)",
      hotspot3:           "hsl(295 100% 62% / 0.7)",
      hotspot4:           "hsl(285 90% 48% / 0.35)",
      hotspot5:           "hsl(275 75% 38% / 0.1)",
      halo1:              "hsl(300 100% 68% / 0.4)",
      halo2:              "hsl(290 90% 52% / 0.2)",
      halo3:              "hsl(278 80% 42% / 0.08)",
      core1:              "hsl(305 100% 90%)",
      core2:              "hsl(300 100% 75%)",
      core3:              "hsl(295 100% 60%)",
      core4:              "hsl(285 100% 50% / 0.5)",
      orb1:               "hsl(300 95% 58%)",
      orb1Tail:           "hsl(295 85% 48% / 0.4)",
      orb2:               "hsl(320 90% 62%)",
      orb2Tail:           "hsl(315 82% 52% / 0.35)",
      orb3:               "hsl(270 95% 55%)",
      orb3Tail:           "hsl(265 85% 45% / 0.35)",
      orb4:               "hsl(310 95% 65%)",
      orb4Tail:           "hsl(308 85% 55% / 0.4)",
      orb5:               "hsl(300 100% 72%)",
      orb5Tail:           "hsl(298 90% 60% / 0.5)",
      buttonGradStart:    "hsl(300 100% 55%)",
      buttonGradEnd:      "hsl(270 100% 58%)",
      buttonGradStartBusy:"hsl(300 65% 40%)",
      buttonGradEndBusy:  "hsl(270 60% 40%)",
      buttonShadow:       "hsl(300 90% 52% / 0.4)",
      liveBadgeBorder:    "hsl(300 90% 65% / 0.45)",
      liveBadgeBg:        "hsl(300 90% 65% / 0.1)",
      liveBadgeDot:       "hsl(300 100% 68%)",
      liveBadgeText:      "hsl(300 100% 80%)",
      accentTextA:        "hsl(300 100% 72%)",
      accentTextB:        "hsl(270 100% 70%)",
      accentTextGlowMid:  "hsl(300 100% 72% / 0.55)",
      accentTextGlowWide: "hsl(270 100% 70% / 0.38)",
      inputFocus:         "hsl(300 90% 62% / 0.5)",
      badgeBoxShadow:     "hsl(300 90% 58% / 0.5)",
      badgeBorder:        "hsl(300 65% 42% / 0.45)",
    }
  }
}
