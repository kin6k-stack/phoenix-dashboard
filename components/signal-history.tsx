              ...
              trades.map((t: any, i: number) => {
                ...
                return (
                  <tr key={i} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="p-4">
                      <span className={`inline-flex items-center gap-1 text-[10px] font-black px-2 py-1 rounded ${isBuy ? 'bg-emerald-500/10 text-emerald-400' : 'bg-rose-500/10 text-rose-400'}`}>
