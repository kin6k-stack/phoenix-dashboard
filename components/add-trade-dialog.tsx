      ...
      <DialogContent className="bg-[#0f172a]/95 backdrop-blur-xl border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.5)] sm:max-w-[425px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <div className="flex justify-end pt-2">
            <button type="submit" className="bg-primary text-primary-foreground font-black uppercase tracking-widest text-[11px] px-6 py-2 rounded shadow-[0_0_15px_rgba(16,185,129,0.3)] hover:bg-primary/90 transition-colors">
              Save Execution
            </button>
          </div>
        </form>
