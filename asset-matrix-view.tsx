...
import { Shield, BarChart3, TrendingUp, DollarSign, ToggleLeft, ToggleRight, Percent } from "lucide-react"
...
export function AssetMatrix({ trades = [] }: AssetMatrixProps) {
  // Toggle filters: "ALL" | "BOT" | "MANUAL"
  const [filterMode, setFilterMode] = useState<"ALL" | "BOT" | "MANUAL">("ALL")

  // Helper filter function matching setup naming properties
  ...
  // Asset isolation parsing variables
